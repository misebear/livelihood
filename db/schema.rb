...
ActiveRecord::Schema[8.1].define(version: 2026_03_05_001022) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "pg_catalog.plpgsql"

  create_table "benefits", force: :cascade do |t|
    t.string "apply_period"
    t.string "apply_url"
    t.string "category"
    ...
    t.string "source"
    t.text "summary"
    t.string "support_amount"
    t.text "target_group"
    t.string "title", null: false
    t.datetime "updated_at", null: false
    t.index ["category"], name: "index_benefits_on_category"
    t.index ["eligibility_type"], name: "index_benefits_on_eligibility_type"
